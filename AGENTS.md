# AI Agent Instructions: FFC-IN-AI-Management
...
These sites deploy to `https://freeforcharity.github.io/FFC-IN-AI-Management/` and optionally to a custom domain if one is configured for this repo.
