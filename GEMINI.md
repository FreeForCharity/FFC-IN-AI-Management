# Gemini Instructions: FFC-IN-AI-Management

Hey Gemini! Welcome to FFC-IN-AI-Management.

**Project:** FFC-IN-AI-Management -- a Free For Charity nonprofit website
...
The site deploys to `https://freeforcharity.github.io/FFC-IN-AI-Management/` (and your custom domain if configured). The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
